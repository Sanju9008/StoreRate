...
export default function SortableHeader({ label, columnKey, currentSort, currentOrder, onSort }) {
    ...
    return (
        <th
            className="px-3 py-2.5 sm:px-4 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-50 transition-colors"
            onClick={handleSort}
        >
