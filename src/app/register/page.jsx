                    ...
                    <div className="grid grid-cols-1 gap-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Enter your full name (at least 20 chars)"
                            />
                        </div>
                            ...
                            <div>
                                ...
                                <div className="mt-2 text-xs text-gray-500 space-y-1">
                                    <p className={`flex items-center gap-1 ${hasLength ? 'text-green-600' : ''}`}>
                                        {hasLength ? <CheckCircle2 className="h-3 w-3" /> : <span className="h-3 w-3 border rounded-full" />}
                                        8-16 chars
                                    </p>
                                    <p className={`flex items-center gap-1 ${hasUpper ? 'text-green-600' : ''}`}>
                                        {hasUpper ? <CheckCircle2 className="h-3 w-3" /> : <span className="h-3 w-3 border rounded-full" />}
                                        1 Uppercase
                                    </p>
                                    <p className={`flex items-center gap-1 ${hasSpecial ? 'text-green-600' : ''}`}>
                                        {hasSpecial ? <CheckCircle2 className="h-3 w-3" /> : <span className="h-3 w-3 border rounded-full" />}
                                        1 Special Char
                                    </p>
                                </div>
                            </div>
